                                ...
                                <div class="inside_padd">
                                    <div class="row-fluid">
                                        <div class="control-group">
                                            <label class="control-label" for="comcount">{lang("Number of comments for display")}:</label>
                                            <div class="controls">
                                                <input id="comcount" type="text" name="comments_count" value="{$widget.settings.comments_count}"/> 
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="symcount">{lang("Maximum number of characters")}:</label>
                                            <div class="controls">
