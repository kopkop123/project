<div class="order-wrap-2" {if $message_sent}style="height:200px;"{/if}><div class="order" {if $message_sent}style="height:200px;"{/if}>
                ...
                <form action="{site_url('/zayavka2')}" id="userForm" enctype="multipart/form-data" method="post">
                    
                    <p style="text-align: center">Заявка <br/>на оказание услуг по осуществлению перевозки грузов<br/></p>
                    <p>Заказчик: &nbsp;&nbsp;
                        <input type="text" name="clientname" size="70" value="{if $_POST.clientname}{$_POST.clientname}{/if}">
                        {if $form_errors_c.clientname}<br/>{$form_errors_c.clientname}{/if}
                    </p>

                    <table class="feedback-widjet" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td>Время и дата подачи заявки</td>
                        <td colspan="2">
                        <input name="bidhours" style="width: 25px;" type="text" size="2" value="{if $_POST.bidhours}{$_POST.bidhours}{/if}">:<input name="bidminutes" style="width: 25px;" type="text" size="2" value="{if $_POST.bidminutes}{$_POST.bidminutes}{/if}">&nbsp;&nbsp;&nbsp;      
                         "<input name="biddate" style="width: 25px;" type="text" id="textfield" size="2" value="{if $_POST.biddate}{$_POST.biddate}{/if}">"<input name="bidmonth" type="text" size="10" value="{if $_POST.bidmonth}{$_POST.bidmonth}{/if}">201<input name="bidyear" style="width: 25px;" type="text" size="2" value="{if $_POST.bidyear}{$_POST.bidyear}{/if}" >
                         г.
                      ...
                      <tr>
                        ...
                        <td >"
                          <input name="fromdate" style="width: 25px;" type="text" size="2" value="{if $_POST.fromdate}{$_POST.fromdate}{/if}">
                          "
                          <input name="frommonth" type="text" size="10" value="{if $_POST.frommonth}{$_POST.frommonth}{/if}">
                          201
                          <input name="fromyear" style="width: 25px;" type="text" size="2" value="{if $_POST.fromyear}{$_POST.fromyear}{/if}">
                    г.
                        ...
                        <td >"
                          <input name="todate" style="width: 25px;" type="text" size="2" value="{if $_POST.todate}{$_POST.todate}{/if}">
                          "
                          <input name="tomonth" type="text" size="10" value="{if $_POST.tomonth}{$_POST.tomonth}{/if}">
                          201
                          <input name="toyear" style="width: 25px;" type="text" size="2" value="{if $_POST.toyear}{$_POST.toyear}{/if}">
                    г.
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="typet" type="text" size="70" value="{if $_POST.typet}{$_POST.typet}{/if}">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="work" type="text" size="70" value="{if $_POST.work}{$_POST.work}{/if}">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="orderhours" style="width: 25px;" type="text" size="2" value="{if $_POST.orderhours}{$_POST.orderhours}{/if}">:<input type="text" style="width: 25px;" name="orderminutes" size="2" value="{if $_POST.orderminutes}{$_POST.orderminutes}{/if}">&nbsp;&nbsp;&nbsp;      
                         "<input name="orderdate" style="width: 25px;" type="text" size="2" value="{if $_POST.orderdate}{$_POST.orderdate}{/if}">"<input name="ordermonth" type="text" size="10" value="{if $_POST.ordermonth}{$_POST.ordermonth}{/if}">201<input name="orderyear" style="width: 25px;" type="text" size="2" value="{if $_POST.orderyear}{$_POST.orderyear}{/if}">
                        г.
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="length" type="text" size="70" value="{if $_POST.length}{$_POST.length}{/if}">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="worktime" type="text" size="70" value="{if $_POST.worktime}{$_POST.worktime}{/if}">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="contactname" type="text" size="70" value="{if $_POST.contactname}{$_POST.contactname}{/if}">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="object2" type="text" size="70" value="{if $_POST.object2}{$_POST.object2}{/if}">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="place2" type="text" size="70" value="{if $_POST.place2}{$_POST.place2}{/if}">
                      ...
                      <tr>
                        <td>Удаленность от города, км</td>
                        <td colspan="2">
                            <input name="length2" type="text" size="70" value="{if $_POST.length2}{$_POST.length2}{/if}">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="worktime2" type="text" size="70" value="{if $_POST.worktime2}{$_POST.worktime2}{/if}">
                      ...
                      <tr>
                        <td>Контактное лицо, телефон</td>
                        <td colspan="2">
                            <input name="contactname2" type="text" size="70" value="{if $_POST.contactname2}{$_POST.contactname2}{/if}">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="tech" type="text" size="70" value="{if $_POST.tech}{$_POST.tech}{/if}">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="liabilityname" type="text" size="70" value="{if $_POST.liabilityname}{$_POST.liabilityname}{/if}">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="weight" type="text" size="70" value="{if $_POST.weight}{$_POST.weight}{/if}">
                      ...
                      <tr>
                        ...
                        <td colspan="2">"
                          <input name="biddate2" type="text" style="width: 25px;" size="2" value="{if $_POST.biddate2}{$_POST.biddate2}{/if}">
                          "
                          <input name="bidmonth2" type="text" size="10" value="{if $_POST.bidmonth2}{$_POST.bidmonth2}{/if}">
                          201
                          <input name="bidyear2" type="text" style="width: 25px;" size="2" value="{if $_POST.bidyear2}{$_POST.bidyear2}{/if}">
                    г.
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="cost" type="text" size="70" value="{if $_POST.cost}{$_POST.cost}{/if}">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                            <input name="addit" type="text" size="70" value="{if $_POST.addit}{$_POST.addit}{/if}">
                    ...
                    {if $captcha_type =='captcha'}
                      <tr class="cust-viz">
                        <td colspan="3" style="font-size:12px;font-style:italic;">На нашем сайте действует защита от спама. Будьте добры, введите символы с картинки латинскими буквами, затем нажмите кнопку «Отправить». Не закрывайте сразу страницу, дождитесь уведомления об успешной отправке. </td>
                      </tr>
                      <tr class="cust-viz">
                          <td colspan="3" style="padding:20px 4px 7px 4px;text-align: center;">
                              <div>{$cap_image}</div>
