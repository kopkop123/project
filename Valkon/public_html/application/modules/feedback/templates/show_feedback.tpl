<div class="order-wrap-2" {if $message_sent}style="height:200px;"{/if}><div class="order" {if $message_sent}style="height:200px;"{/if}>
                ...
                <form action="{site_url('/zayavka1')}" id="userForm" enctype="multipart/form-data" method="post">
                    
                    <p style="text-align: center">Заявка <br/>на оказание услуг по предоставлению строительно-дорожной техники<br/></p>
                    <p>Заказчик: &nbsp;&nbsp;
                    ...
                    <table class="feedback-widjet" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td colspan="2">
                        <input name="bidhours" style="width: 25px;" type="text" size="2" value="{if $_POST.bidhours}{$_POST.bidhours}{/if}">:<input name="bidminutes" type="text" style="width: 25px;" size="2" value="{if $_POST.bidminutes}{$_POST.bidminutes}{/if}">&nbsp;&nbsp;&nbsp;      
